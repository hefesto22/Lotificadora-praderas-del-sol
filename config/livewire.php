...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        /*
         * ═══ 🔴 SUBIDO DE 12 MB A 30 POR LAS FOTOS 360 ═══
         *
         * Este es el ÚNICO motivo por el que este archivo está publicado.
         *
         * Livewire valida el archivo temporal ANTES que las reglas del campo,
         * así que su tope de 12 MB gana siempre: una foto de cámara 360 —15 o
         * 20 MB— se rechazaba con «no debe ser mayor que 12288 kilobytes»
         * antes de que `Foto360` llegara a mirarla siquiera.
         *
         * Que entren 30 MB no significa que se guarden 30 MB: lo que queda en
         * disco son 4096×2048 y medio mega. Ver `App\Domain\Plano\Foto360`.
         *
         * ⚠️ Si el servidor tiene `upload_max_filesize` o `post_max_size` por
         * debajo de 30M, PHP corta antes que esto y el error ni siquiera llega
         * a Laravel. Los tres tienen que acompañarse.
         */
